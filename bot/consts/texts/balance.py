...
REACHED_DAILY_LIMIT = 'Досягнутий денний ліміт на вивід! Сьогодні ще можна вивести: {allowable_amount} 💎'
PREVIOUS_WITHDRAW_IN_PROCESS = 'Дочекайтесь оброблення попередньої транзакції'
WITHDRAW_TOO_BIG = 'Максимальний денний ліміт - {daily_limit} 💎 ({daily_limit_token} TON)'

AMOUNT_TOO_SMALL = 'Мінімальна сума для виведення: {min_withdraw} 💎 ({ton_amount} TON)'
TON_TESTNET_ADDRESS = '❌ Голова, це тест-нетівська адреса, будь уважніше'
WRONG_ADDRESS = '❌ Невірно введено адресу'
INSUFFICIENT_FUNDS = '❌ Бажаної суми виводу нема на вашому рахунку'
INSUFFICIENT_FUNDS_MASTER = 'На мастер-рахунку не вистачає грошей. Токени повернені на баланс'
