...
WITHDRAW_DAILY_LIMIT = 'Досягнутий денний ліміт на вивід! Сьогодні ще можна вивести: {amount} TON'
PREVIOUS_MANUAL_TX_IN_PROCESS = 'Дочекайтесь оброблення попередньої транзакції'
INPUT_AMOUNT_BIGGER_MAXIMUM_WITHDRAW = 'Максимальний вивід - {maximum_withdraw} TON'
