...
ADMIN_APPROVE_TX = 'Адмін схвалив вашу транзу на виведення {amount} TON! Очікуйте поповнення :)'
WITHDRAW_TITAN_TX = '@{username} (id: {user_id}) хоче вивести купу грошей: {ton_amount} TON.'
WITHDRAW_DAILY_LIMIT = 'Майже досягнутий денний ліміт на вивід! Сьогодні ще можна вивести: {amount} TON'
