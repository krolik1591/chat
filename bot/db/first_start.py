from .db import TitanTXs, Token, User, Balance, Transactions, GameLog, Wallets_key, manager
...
async def first_start():
    ...
    await manager.create_tables(Wallets_key, Token, User, Balance, Transactions, TitanTXs, GameLog)
