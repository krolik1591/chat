...
from bot.menus.deposit_menus.withdraw_menu.withdraw_manual_tx_menu import process_manual_tx_menu
...
async def process_titan_tx(user_id, username, ton_amount, context, token, user_withdraw_address):
    with manager.pw_database.atomic():
        ...
        text, keyboard = process_manual_tx_menu(user_id, username, ton_amount, id_new_tx)
        try:
